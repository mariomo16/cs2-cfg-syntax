...
All notable changes to the "CS2 Config Support" extension will be documented in this file.
...
- Avoid mutating command data when generating fallback descriptions, preventing unintended side effects on the shared commands dataset.

### Changed

- Cache rendered hover documentation per command instead of rebuilding it on every hover, improving hover responsiveness.
...
- **IntelliSense support**: Autocompletion and hover information for CS2 ConVars and ConCommands in `.cfg` files.

### Fixed

- **Language Configuration**: Corrected the `lineComment` comment token syntax to ensure standard comment actions (`//`) and consistent automated block formatting.

## [1.1.2] - 2026-05-16

### Fixed

- Fixed +/- action commands (attack, jump, duck, reload, etc.) not being highlighted

## [1.1.1] - 2026-05-12

### Changed

- Updated images to use the latest version of CS2 Config Syntax
- Updated README to match theme used in the preview screenshots

## [1.1.0] - 2026-05-12

### Added

- Added support for `de_cache` map name highlighting

## [1.0.3] - 2026-03-20

### Added

- Added support for '-' prefix in syntax highlighting
